...
Это относится и к обработчикам исключений - если мы не используем информацию о возникшем исключении, то можем использовать `_`, чтобы явно указать на это и избежать сообщения об ошибке:
