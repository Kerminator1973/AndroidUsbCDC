...
Для сборки приложения из файла с исходными текстами на С++, следует установить путь к файлам сборки:

```shell
SET PATH="c:\Users\kermi\AppData\Local\Android\Sdk\ndk\25.2.9519653\toolchains\llvm\prebuilt\windows-x86_64\bin";%PATH%
```

Проверить корректность настройки пути можно командой: `echo %PATH%`
